...
uniform sampler2D u_tex0;// ../data/reference/CMH_oilpaint.png
uniform sampler2D u_tex1;// ../data/reference/IMG_0712.JPG
...
void main(){
  ...
  vec2 texel=pixelSize*1./u_resolution.xy;
  
  // Gaussian kernels
  float kernelSmall[9];
  kernelSmall[0]=0./16.;kernelSmall[1]=0./16.;kernelSmall[2]=0./16.;
  kernelSmall[3]=4./16.;kernelSmall[4]=8./16.;kernelSmall[5]=4./16.;
  kernelSmall[6]=0./16.;kernelSmall[7]=0./16.;kernelSmall[8]=0./16.;
  vec2 offset[9];
  offset[0]=vec2(-1,-1);
  offset[1]=vec2(0,-1);
  offset[2]=vec2(1,-1);
