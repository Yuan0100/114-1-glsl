...
uniform sampler2D u_tex1;//../../data/wave_wave_logo.png
...
// ---
#define MIN_ELLIPSE_ASPECT_RATIO 2.

#define MUTATION_RATE.02// 0.5% chance to accept a worse color
...
void main()
{
  ...
  if(shapeTypeCount>0){
    ...
    if(shapeChoice==currentIndex){
      ...
      float radius=Random_Final(testUV,iTime*3.)*.25;
